...
public class MiscRecipesFallbackGTNN {
    ...
    private static void crushedSpruce(Consumer<FinishedRecipe> provider){
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("crushed_leaves").duration(200).EUt(30)
                .circuitMeta(14)
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("crushed_sapling").duration(200).EUt(60)
                .circuitMeta(14)
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("crushed_log").duration(200).EUt(120)
                .circuitMeta(14)
                .inputItems(Items.SPRUCE_SAPLING, 1)
    ...
    private static void spruceOil(Consumer<FinishedRecipe> provider){
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("spruce_oil_shsteam").duration(900).EUt(120)
                .circuitMeta(18)
        ...
        GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder("spruce_oil_steam").duration(1200).EUt(120)
                .circuitMeta(16)
                .inputItems(GTCAItems.CrushedSpruce, 64)
