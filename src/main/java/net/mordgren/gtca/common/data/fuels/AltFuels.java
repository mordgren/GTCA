...
public class AltFuels {
    ...
    private static void dymethylEther(Consumer<FinishedRecipe> provider) {
        ...
        BLAST_RECIPES.recipeBuilder("aluminosilicate_catalyst_sio4").EUt(96).duration(60)
                ...
                .inputItems(ChemicalHelper.get(TagPrefix.dust, Aluminium, 1))
                .inputItems(ChemicalHelper.get(TagPrefix.dust, Silicon, 1))
                .outputItems(ChemicalHelper.get(TagPrefix.dust, (GTCAMaterials.AluminosilicateCatalyst), 1))
                .save(provider);
        ...
        BLAST_RECIPES.recipeBuilder("aluminosilicate_catalyst_sio2").EUt(96).duration(60)
                ...
                .inputItems(ChemicalHelper.get(TagPrefix.dust, Aluminium, 1))
                .inputItems(ChemicalHelper.get(TagPrefix.dust, SiliconDioxide, 1))
                .outputItems(ChemicalHelper.get(TagPrefix.dust, (GTCAMaterials.AluminosilicateCatalyst), 1))
                .save(provider);

        INSTANCE.getDEHYDRATOR_RECIPES().recipeBuilder("dymethyl_ether").EUt(1280).duration(240)
                .inputFluids(Methanol.getFluid(4000))
                .chancedInput(ChemicalHelper.get(TagPrefix.dust, (GTCAMaterials.AluminosilicateCatalyst), 1), 7400, 0)
                .chancedOutput(ChemicalHelper.get(TagPrefix.dust, Zeolite, 1),2000,0)
                .outputFluids(GTCAMaterials.DymethylEther.getFluid(12000))
                .save(provider);
    }
    private static ChemicalHelper getItem()
}
