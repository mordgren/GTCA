...
public class GTCACasings {
    ...
    public static final BlockEntry<Block> VITALLIUM_CASING = CasingBuilder.createCasingBlock("vitallium_casing",
    ...
    public static final BlockEntry<Block> SHD_CASING = CasingBuilder.createCasingBlock("shd_casing",
