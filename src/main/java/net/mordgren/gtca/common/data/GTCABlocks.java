...
public class GTCABlocks {
    ...
    public static BlockEntry<Block> SPACE_ELEVATOR_CASING = createCasingBlock("space_elevator_base_casing",
            GTCA.id("block/casing/space_elevator_base_casing"));

    public static BlockEntry<Block> NEUTRONIUM_PLATED_REINFORCED_STONE = createCasingBlock("neutronium_plated_reinforced_stone",
            GTCA.id("block/casing/neutronium_plated_reinforced_stone"));
