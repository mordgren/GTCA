...
public class CometRecipes {
    ...
    private static void Comet(Consumer<FinishedRecipe> provider) {
        ...
        COMET_CYCLOTRON.recipeBuilder("hydrogen_ion_simple").EUt(30720).duration(400)
                ...
                .chancedOutput(GTCAItems.HydrogenIon.asStack(2), 500, 0)
                .chancedOutput(GTCAItems.HydrogenIon.asStack(2), 500, 0)
                .chancedOutput(GTCAItems.HydrogenIon.asStack(2), 500, 0)
                .chancedOutput(GTCAItems.HydrogenIon.asStack(2), 500, 0)
                .chancedOutput(GTCAItems.HydrogenIon.asStack(2), 500, 0)
        ...
        COMET_CYCLOTRON.recipeBuilder("helium_ion_simple").EUt(122880).duration(1600)
                ...
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 250, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 260, 0)
                .chancedOutput(GTCAItems.HeliumIon.asStack(2), 275, 0)
                .save(provider);
        ...
        COMET_CYCLOTRON.recipeBuilder("proton_simple").EUt(30720).duration(400)
                ...
                .chancedOutput(GTCAItems.Proton.asStack(18), 750, 0)
                .chancedOutput(GTCAItems.Proton.asStack(18), 750, 0)
                .chancedOutput(GTCAItems.Proton.asStack(18), 750, 0)
                .chancedOutput(GTCAItems.Proton.asStack(18), 750, 0)
                .chancedOutput(GTCAItems.Proton.asStack(18), 750, 0)
        ...
        COMET_CYCLOTRON.recipeBuilder("unknown").EUt(30720).duration(1600)
                ...
                .inputFluids(Hydrogen.getFluid(1000))
                .inputItems(GTCAItems.HydrogenIon,1)
                .chancedOutput(GTCAItems.Proton.asStack(8), 1250, 0)
                .chancedOutput(GTCAItems.Neutron.asStack(16), 1250, 0)
                .chancedOutput(GTCAItems.Electron.asStack(16), 1250, 0)
