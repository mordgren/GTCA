...
public final class GTCASpaceMiningAsteroids {
    ...
    public static void init() {
        SpaceMiningRegistry.clear();

        GTCA.LOGGER.info("[SpaceMining] Registering asteroids...");
        ...
        AsteroidBuilder.asteroid(GTCA.id("asteroid/ruby"))
                ...
                .droneTiers(DroneTier.MK1_LV, DroneTier.MK6_LuV)
                .drillRange(DrillMaterialTier.STEEL, DrillMaterialTier.TUNGSTEN_STEEL)
                .ore(GTMaterials.Ruby, 0.13)
                .ore(GTMaterials.Emerald, 0.13)
                .ore(GTMaterials.Sapphire, 0.13)
                .ore(GTMaterials.GreenSapphire, 0.13)
                ...
                .ore(GTMaterials.NetherStar, 0.015)
