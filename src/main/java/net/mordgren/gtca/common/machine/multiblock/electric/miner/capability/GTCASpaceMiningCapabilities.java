...
public final class GTCASpaceMiningCapabilities {
    ...
    public static void register(GTCEuAPI.RegisterEvent.String<RecipeCapability<?>> event) {
        event.register("gtca:space_mining_info", SpaceMiningInfoRecipeCapability.CAP);
    }
}
